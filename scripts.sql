...
CREATE TABLE IF NOT EXISTS `mydb`.`advice` (
  ...
  INDEX `fk_Advice_Category1_idx` (`Category_idCategory` ASC) VISIBLE,
  CONSTRAINT `fk_Advice_Category1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`user` (
  ...
  `created_at` TIMESTAMP NULL DEFAULT NULL,
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  `Advice_idAdvice` INT NOT NULL,
  PRIMARY KEY (`idUser`),
  UNIQUE INDEX `idUser_UNIQUE` (`idUser` ASC) VISIBLE,
  INDEX `fk_User_Advice1_idx` (`Advice_idAdvice` ASC) VISIBLE,
  CONSTRAINT `fk_User_Advice1`
    FOREIGN KEY (`Advice_idAdvice`)
    REFERENCES `mydb`.`advice` (`idAdvice`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
CREATE TABLE IF NOT EXISTS `mydb`.`care` (
  ...
  INDEX `fk_Care_User_idx` (`User_idUser` ASC) VISIBLE,
  CONSTRAINT `fk_Care_User`
...
CREATE TABLE IF NOT EXISTS `mydb`.`post` (
  ...
  `created_at` TIMESTAMP NULL DEFAULT NULL,
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  `Care_idCare` INT NOT NULL,
  `Pictures_idPictures` INT NOT NULL,
  `read` TINYINT NOT NULL,
  PRIMARY KEY (`idPost`),
  UNIQUE INDEX `idPost_UNIQUE` (`idPost` ASC) VISIBLE,
  INDEX `fk_Post_Care1_idx` (`Care_idCare` ASC) VISIBLE,
  INDEX `fk_Post_Pictures1_idx` (`Pictures_idPictures` ASC) VISIBLE,
  CONSTRAINT `fk_Post_Care1`
    FOREIGN KEY (`Care_idCare`)
    REFERENCES `mydb`.`care` (`idCare`),
  CONSTRAINT `fk_Post_Pictures1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`verification` (
  `idVerif` INT NOT NULL,
  `type` TINYINT NOT NULL,
  `created_at` TIMESTAMP NULL DEFAULT NULL,
  `User_idUser` INT NOT NULL,
  PRIMARY KEY (`idVerif`),
  UNIQUE INDEX `idVerif_UNIQUE` (`idVerif` ASC) VISIBLE,
  INDEX `fk_Verification_User1_idx` (`User_idUser` ASC) VISIBLE,
